      ...
      >
        ...
        <nav className="flex-1 p-3 space-y-1 overflow-y-auto custom-scrollbar">
          ...
          >
            ...
            <span className="truncate">Trend-up Breadth</span>
          </Link>
          ...
          >
            ...
            <span className="truncate">AVWAP 수급</span>
          </Link>
          ...
          >
            ...
            <span className="truncate">수익률</span>
          </Link>
          ...
          >
            ...
            <span className="truncate">Above MA & 수급</span>
          </Link>
          ...
          >
            ...
            <span className="truncate">외국인 현선물</span>
          </Link>
          ...
          >
            ...
            <span className="truncate">Stockbee MM</span>
          </Link>
          ...
          >
            ...
            <span className="truncate">시총 TOP 30</span>
          </Link>
