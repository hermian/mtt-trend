    ...
    >
      ...
      <nav className="flex-1 p-3 space-y-1">
        ...
        <Link
          ...
          title={collapsed ? "AVWAP 차트" : undefined}
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="w-5 h-5 flex-shrink-0"
        ...
        <Link
          ...
          title={collapsed ? "PER/PBR 밴드" : undefined}
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="w-5 h-5 flex-shrink-0"
          ...
          {!collapsed && <span className="truncate">PER/PBR 밴드</span>}
        </Link>
        {/* 외국인 현선물 */}
        <Link
          ...
          title={collapsed ? "외국인 현선물" : undefined}
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="w-5 h-5 flex-shrink-0"
          ...
          {!collapsed && <span className="truncate">외국인 현선물</span>}
        </Link>
        ...
        <Link
          ...
          title={collapsed ? "Stockbee MM" : undefined}
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="w-5 h-5 flex-shrink-0"
