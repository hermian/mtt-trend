...
const INDICATORS: IndicatorDef[] = [
  ...
  { id: "vxsmh", label: "VXSMH", color: "#d946ef", raw: (v) => `VXSMH ${v.toFixed(1)}` },
  ...
  { id: "copper", label: "Copper", color: "#b45309", raw: (v) => `Copper $${v.toFixed(3)}` },
  { id: "gold", label: "Gold", color: "#eab308", raw: (v) => `Gold $${v.toFixed(1)}` },
  { id: "silver", label: "Silver", color: "#cbd5e1", raw: (v) => `Silver $${v.toFixed(2)}` },
  ...
  { id: "unrate", label: "실업률", color: "#14b8a6", raw: (v) => `실업률 ${v.toFixed(1)}%` },
  { id: "cpi", label: "CPI", color: "#ef4444", raw: (v) => `CPI ${v.toFixed(2)}%` },
  { id: "core_cpi", label: "CORE CPI", color: "#f97316", raw: (v) => `CORE ${v.toFixed(2)}%` },
  { id: "sticky_cpi", label: "Sticky CPI", color: "#f59e0b", raw: (v) => `Sticky ${v.toFixed(2)}%` },
